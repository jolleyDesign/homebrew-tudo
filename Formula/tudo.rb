class Tudo < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/jolleyDesign/tudo/releases/download/v1.0.1/tudo-aarch64-apple-darwin.tar.gz"
      sha256 "73eac6930d9df03a2d16698afc8126f50a5c419897f908b105d3f29db4fd09a4"
    end
    on_intel do
      url "https://github.com/jolleyDesign/tudo/releases/download/v1.0.1/tudo-x86_64-apple-darwin.tar.gz"
  ...
  on_linux do
    on_arm do
      url "https://github.com/jolleyDesign/tudo/releases/download/v1.0.1/tudo-aarch64-unknown-linux-musl.tar.gz"
      sha256 "b870c39689c6696ce8a70c7660a8e200ec01c336230f90d474732ea127215a64"
    end
    on_intel do
      url "https://github.com/jolleyDesign/tudo/releases/download/v1.0.1/tudo-x86_64-unknown-linux-musl.tar.gz"

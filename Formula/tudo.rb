class Tudo < Formula
    ...
    on_macos do
      on_arm do
        url "https://github.com/jolleyDesign/tudo/releases/download/v1.0.4/tudo-aarch64-
  apple-darwin.tar.gz"
        sha256 "8ef09d266659046b02f481e167005327fa0bbd773f6458f8fdbd46d89f9c9051"
      end
      on_intel do
        url "https://github.com/jolleyDesign/tudo/releases/download/v1.0.4/tudo-x86_64-a
  pple-darwin.tar.gz"
  ...
  unknown-linux-musl.tar.gz"
    ...
    on_linux do
      on_arm do                                                                         -apple-darwin.tar.gz"                                                                       end

    on_linux do
      on_arm do
        url "https://github.com/jolleyDesign/tudo/releases/download/v1.0.4/tudo-aarch64-
  unknown-linux-musl.tar.gz"                                                                    sha256 "75464258c11df751793eb5a599acedea68af2cc90930a4fefc259e85a4ad7dc5"
      end
      on_intel do
        url "https://github.com/jolleyDesign/tudo/releases/download/v1.0.4/tudo-x86_64-u
  nknown-linux-musl.tar.gz"
